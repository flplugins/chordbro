...
private:
    ...
    void migrateLegacyPresetLibrary();
    void migrateLegacyFactoryPresets (StringPairArray& renamedPresetNames);
    void migrateLegacyPremiumPresets (StringPairArray& renamedPresetNames);
    void migrateStoredPresetNames (const StringPairArray& renamedPresetNames);
    void scrubFavs();
    void scrubTags();
