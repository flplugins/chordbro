    ...
    mMidiState (mMainProcess.getMidiState())
{
    ...
    mChordNameInput.setColour (TextEditor::textColourId, COLOR_WHITE);
    mChordNameInput.setColour (TextEditor::highlightColourId, COLOR_BLUE.withAlpha (0.35f));
    mChordNameInput.setColour (TextEditor::highlightedTextColourId, COLOR_WHITE);
    mChordNameInput.setColour (CaretComponent::caretColourId, COLOR_GOLD);
    ...
    mChordNameLabel.setColour (Label::textColourId, COLOR_WHITE.withBrightness (1.02f));
...
void ChordNameComponent::resized()
{
    ...
    auto displayFont = Styles::getDisplayFont (area.getHeight() * 0.58f, true, 0.008f);
    auto inputFont = Styles::getUiFont (area.getHeight() * 0.54f, true, 0.012f);

    mChordNameLabel.setFont (displayFont);
    mChordNameInput.setFont (inputFont);
