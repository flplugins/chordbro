    ...
    mMidiState (mMainProcess.getMidiState())
{
    ...
    mPresetNameInput.setColour (TextEditor::textColourId, COLOR_WHITE);
    mPresetNameInput.setColour (TextEditor::highlightColourId, COLOR_BLUE.withAlpha (0.35f));
    mPresetNameInput.setColour (TextEditor::highlightedTextColourId, COLOR_WHITE);
    mPresetNameInput.setColour (CaretComponent::caretColourId, COLOR_GOLD);
    ...
    mPresetNameLabel.setColour (Label::textColourId, COLOR_WHITE.withBrightness (1.02f));
...
void PresetNameComponent::resized()
{
    ...
    auto displayFont = Styles::getDisplayFont (area.getHeight() * 0.63f, true, 0.01f);
    auto inputFont = Styles::getUiFont (area.getHeight() * 0.56f, true, 0.012f);

    mPresetNameInput.setFont (inputFont);
    mPresetNameLabel.setFont (displayFont);
