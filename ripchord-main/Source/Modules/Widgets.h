...
public:
    ...
    Widgets()
    {
        ...
        setColour (Label::textColourId, COLOR_WHITE.withAlpha (0.88f));
        setColour (Label::textWhenEditingColourId, COLOR_WHITE);
        setColour (Label::backgroundWhenEditingColourId, COLOR_TRANSPARENT);

        setColour (TextEditor::textColourId, COLOR_WHITE.withAlpha (0.9f));
        setColour (TextEditor::highlightedTextColourId, COLOR_THEME_DARK);
        setColour (TextEditor::backgroundColourId, COLOR_TRANSPARENT);
        setColour (TextEditor::highlightColourId, COLOR_BLUE.withAlpha (0.8f));
        ...
        setColour (Slider::rotarySliderFillColourId, COLOR_BLUE);
        setColour (Slider::rotarySliderOutlineColourId, COLOR_BORDER.brighter (0.3f));

        setColour (ScrollBar::thumbColourId, COLOR_BORDER.brighter (0.45f));
        setColour (CaretComponent::caretColourId, COLOR_GOLD);
    };
                            ...
                            bool inIsMouseOver, bool inIsMouseDragging) override
    {
        ...
        inGraphics.setColour (COLOR_BORDER.brighter (0.2f));
        inGraphics.fillPath (trianglePath);

        const float lineThickness = 1.f;
        inGraphics.setColour (COLOR_WHITE.withAlpha (0.18f));
